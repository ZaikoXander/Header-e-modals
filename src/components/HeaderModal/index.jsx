  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-8 rounded shadow-lg max-w-sm w-full relative">
        ...
        <p className="text-gray-700">Para utilizar nosso site é simples, basta escolher uma das instituições Fatec em nosso mapa ou procurar através da barra de pesquisa, e então será exibida sua seção de informações, de curso e comentários.</p>
      </div>
    </div>
  );
};
